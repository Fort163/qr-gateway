...
public class NotificationMessageDto extends SmartDto {
    ...
    @Null(message = "{validation.field.cannot.be.changed.notification.message}", groups = {Put.class,Patch.class})
    @NotNull(message = "{validation.field.required.when.post}", groups = {Post.class})
